...
ENT.Contact			= ""
ENT.Purpose			= "Accelerates the growth of Tiberium Crystals in the area that the accelerator is active, this accelerator has a range up to 256 units"
...
WTib.Factory.AddObject({
	...
	Model = "models/tiberium/acc_s.mdl",
	PercentDelay = 0.05,
	Information =	{
						ENT.PrintName,
						"\nPurpose :\n" .. ENT.Purpose,
